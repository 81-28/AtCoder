...
- **座標圧縮＋遅延評価セグメント木・区間被覆幅管理・採用,不採用を区間更新し、区間内で採用された幅の合計をクエリで求める・(ACL)**: [`abc435_e_SegTree_range.cpp`](archive/25_12_09/abc435_e_SegTree_range.cpp), [`abc435_e_SegTree_range_ACL.cpp`](archive/25_12_18/abc435_e_SegTree_range_ACL.cpp)
- **木に対するEuler Tour + セグメント木・辺の重み更新・パス和(区間和)・LCA・RMQ**: [`abc294_g_DFS_Euler_Tour_SegTree.cpp`](archive/25_12_16/abc294_g_DFS_Euler_Tour_SegTree.cpp)
